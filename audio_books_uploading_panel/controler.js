...
form_data.append("folder_path",document.getElementById("select_book").innerHTML);
form_data.append("book_id",document.getElementById("select_book").value);
...
function getBooks() {
    ...
    request.open("GET", "../audio_books/fetch_all_audio_books.php", true);
    ...
    // This is unnecessary for GET requests
